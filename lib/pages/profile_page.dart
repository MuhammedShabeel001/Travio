      ...
      children: [
        Column(
          ...
          children: [
            ...
            Text(
              'Lisa Smith',
              style: TextStyle(fontWeight: FontWeight.bold, fontSize: 26, color: TTthemeClass().ttLightText),
            ),
            const Text(
              'She/her',
              style: TextStyle(fontSize: 15, color: Color.fromRGBO(0, 0, 0, 0.5)),
            ),
            const Text(
              'lisasmith@gmail.com',
              style: TextStyle(fontSize: 15, color: Color.fromRGBO(0, 0, 0, 0.5)),
              ...
              child: Column(
                children: [
                  ListTile(
                    ...
                    title: Text('Wishlist', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: TTthemeClass().ttLightText)),
                  ...
                  ListTile(
                    ...
                    title: Text('History', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: TTthemeClass().ttLightText)),
                    trailing: Icon(Icons.arrow_forward_ios, color: TTthemeClass().ttLightText),
                  ),
                  ListTile(
                    leading: Icon(Icons.color_lens, color: TTthemeClass().ttLightText),
                    title: Text('Theme', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: TTthemeClass().ttLightText)),
                    trailing: Icon(Icons.arrow_forward_ios, color: TTthemeClass().ttLightText),
                  ),
                  ListTile(
                    leading: Icon(Icons.edit, color: TTthemeClass().ttLightText),
                    title: Text('Edit profile', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: TTthemeClass().ttLightText)),
                    trailing: Icon(Icons.arrow_forward_ios, color: TTthemeClass().ttLightText),
                  ),
                  ListTile(
                    leading: Icon(Icons.lock, color: TTthemeClass().ttLightText),
                    title: Text('Privacy Policy', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: TTthemeClass().ttLightText)),
                    trailing: Icon(Icons.arrow_forward_ios, color: TTthemeClass().ttLightText),
                  ),
                  ListTile(
                    leading: Icon(Icons.edit_document, color: TTthemeClass().ttLightText),
                    title: Text('Terms of Service', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: TTthemeClass().ttLightText)),
                    trailing: Icon(Icons.arrow_forward_ios, color: TTthemeClass().ttLightText),
                  ),
                  ListTile(
                    leading: Icon(Icons.delete, color: TTthemeClass().ttLightText),
                    title: Text('Delete my account', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: TTthemeClass().ttLightText)),
                    trailing: Icon(Icons.arrow_forward_ios, color: TTthemeClass().ttLightText),
                  ),
                  ListTile(
                    onTap: () {
